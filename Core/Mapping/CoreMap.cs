...
namespace Core.Mapping
{
    public class CoreMap<T> : IEntityTypeConfiguration<T> where T : CoreEntity
    {
        public virtual void Configure(EntityTypeBuilder<T> builder)
        {
            ...
            builder.Property(x => x.CreatedADUserName).HasColumnName("Created AD Username").IsRequired(false);
            ...
            builder.Property(x => x.ModifiedADUserName).HasColumnName("Modified AD Username").IsRequired(false);
